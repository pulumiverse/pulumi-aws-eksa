...
namespace Pulumi.AwsEksa
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AwsEksa.version.txt");
    ...
    internal sealed class AwsEksaResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AwsEksaResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
